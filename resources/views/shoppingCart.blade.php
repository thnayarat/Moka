            ...
            <div class="wrap-table-shopping-cart bgwhite">
                <table class="table-shopping-cart">
                    ...
                    <tr class="table-row">
                        ...
                        <div class="btn-group">
                            <a type="button" class="btn btn-secondary" href="{{route('addtocart', $product['item']['id'])}}">+</a>
                            <a type="button" class="btn btn-secondary" href="{{route('reducebyone', $product['item']['id'])}}">-</a>
                            <a type="button" class="btn btn-secondary" href="{{route('removeitem', $product['item']['id'])}}">Remove</a>
                        </div>
                        </td>
                        <td class="column-5">‎฿ {{($product['price']*$product['qty'])}}</td>
                    </tr>
                    @endforeach
                </table>
            </div>
